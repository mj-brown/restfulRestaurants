...
router.get("/:id", (req, res) => {
  ...
  const starredRestaurant = STARRED_RESTAURANTS.find((starredRestaurant) => starredRestaurant.id === id);

  // If the starred restuarant doesn't exist, let the client know.
...
router.delete("/:id", (req, res) => {
  ...
  const newListOfStarredRestaurants = STARRED_RESTAURANTS.filter((starredRestaurant) => starredRestaurant.id === id);
